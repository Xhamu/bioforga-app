...
class ParteTrabajoSuministroOtros extends Model
{
    ...
    {
        if (!$this->fecha_hora_inicio_otros) {
            return 0;
        }

        $inicio = $this->fecha_hora_inicio_otros instanceof Carbon
            ? $this->fecha_hora_inicio_otros
            : Carbon::parse($this->fecha_hora_inicio_otros);

        $finReferencia = $this->fecha_hora_fin_otros
            ? ($this->fecha_hora_fin_otros instanceof Carbon
                ? $this->fecha_hora_fin_otros
                : Carbon::parse($this->fecha_hora_fin_otros))
            : now();
